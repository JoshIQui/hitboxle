...
const postUser = (object, isNewUser) => {
    users[object.username] = { username: object.username, guesses: object.guesses, completed: object.completed };

    editUserStatistics(object, isNewUser);
};
...
const editUserStatistics = (object, isNewUser) => {
    let numberOfUsers = 0;
